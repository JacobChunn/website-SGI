...
import { Button, CheckboxField, Flex, Icon, SelectField, TextAreaField, TextField } from "@aws-amplify/ui-react"
...
type SubmittingStateType = "unsubmitted" | "submitting" | "submitted" | "error";
...
export default function ContactForm({
  ...
  const [submittingState, setSubmittingState] = useState<SubmittingStateType>("unsubmitted");
  ...
  return (
    ...
    >
      <ThankYouModal
        isOpen={submittingState == "submitted"}
        onClose={() => {
          setFormState(defaultFormState)
          setSubmittingState("unsubmitted")
        }}
        firstname={formState.firstName}
      />
      ...
      <CheckboxField
        ...
        hasError={checkboxHasError || submittingState == "error"}
        errorMessage={
          checkboxHasError ? "Please agree to the terms and conditions" : "There was an error submitting your form. Please try again or refresh."}
        name="privacy"
        value="yes"
        width="100%"
      ...
      <Button
        ...
        alignSelf={'center'}
        type='submit'
        isLoading={submittingState == "submitting"}
      >
        Send My Message
      </Button>
